...
open class RemoveparamFilter(parameter: String?, inverse: Boolean) :
    ModifyFilter(parameter, inverse) {
    override val prefix get() = MODIFY_PREFIX_REMOVEPARAM
}

class RemoveparamRegexFilter(parameter: String, inverse: Boolean) :
