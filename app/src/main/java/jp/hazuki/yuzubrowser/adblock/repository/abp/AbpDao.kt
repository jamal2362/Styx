...
class AbpDao(val context: Context) {
    private val prefs: SharedPreferences =
        context.getSharedPreferences("ad_block_settings", Context.MODE_PRIVATE)
...
val ABP_ENTITY_ADGUARD = AbpEntity(title = "AdGuard Base Filter",
    entityId = 1,
    url = "https://filters.adtidy.org/extension/chromium/filters/2.txt",
    homePage = "https://github.com/AdguardTeam/AdguardFilters")
val ABP_ENTITY_EASYLIST = AbpEntity(title = "EasyList",
    entityId = 2,
    url = "https://easylist.to/easylist/easylist.txt",
    homePage = "https://easylist.to")
val ABP_ENTITY_EASYPRIVACY = AbpEntity(title = "EasyPrivacy",
    entityId = 3,
    url = "https://easylist.to/easylist/easyprivacy.txt",
    homePage = "https://easylist.to")
val ABP_ENTITY_URLHAUS = AbpEntity(title = "URLhaus Malicious URL Blocklist",
    entityId = 4,
    url = "https://raw.githubusercontent.com/curbengh/urlhaus-filter/master/urlhaus-filter-agh-online.txt",
    homePage = "https://gitlab.com/curben/urlhaus-filter")

val ABP_DEFAULT_ENTITIES = setOf(
    ABP_ENTITY_ADGUARD.toString(),
